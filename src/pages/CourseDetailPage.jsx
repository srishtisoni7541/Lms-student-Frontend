    ...
    <div className="min-h-screen w-full bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          {/* Left Sidebar */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden lg:sticky top-4">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            {currentLesson ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 text-center">
                <BookOpen className="h-10 sm:h-12 w-10 sm:w-12 text-gray-400 mx-auto mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                  Ready to Start Learning?
                </h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                  Select any lesson from the course curriculum to begin your learning journey.
                </p>
                <button
                  onClick={() => {
                    if (modules.length && modules[0].lessons?.length) {
                  ...
                  className="bg-indigo-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-indigo-700 transition-colors"
                >
                  Start with First Lesson
                </button>
              </div>
